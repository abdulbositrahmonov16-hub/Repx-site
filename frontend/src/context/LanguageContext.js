...
const translations = {
  ru: {
    ...
    home_tshirts_desc: 'Футболки, шорты, носки',
    ...
    admin_home_images_desc: 'Эти три фото показываются на главной странице для категорий «Кроссовки», «Одежда» и «Кроссфит». Загрузите свои картинки.',
  ...
  uz: {
    ...
    home_tshirts_desc: 'Futbolka, shorti, paypoq',
    ...
    f_tshirts: 'KIYIM',
    sub_all: 'HAMMASI',
    sub_tshirts: 'FUTBOLKALAR',
    sub_shorts: 'SHORTILAR',
    sub_socks: 'PAYPOQLAR',
    f_crossfit: 'CROSSFIT',
    st_all: 'Hammasi',
    st_in: 'Mavjud',
